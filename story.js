...
export const MAPS = {
  ...
  overworld: {
    ...
    ambience: 'open',
    subZones: [
      { name:'RENDER STREET', x0:10, x1:28, y0:18, y1:30, tier:0 },
      { name:'PIXEL PLAINS',  x0:0,  x1:40, y0:0,  y1:56, tier:0 },
      { name:'DARK MARGINS',  x0:40, x1:56, y0:0,  y1:40, tier:1 },
    ],
    connections: [
      { destMap:'home',  destX:5,  destY:7,  triggerX:15, triggerY:23 },
      { destMap:'town',  destX:2,  destY:11, triggerX:54, triggerY:25 },
    ],
  },
  town: {
    ...
    ambience: 'safe',
    connections: [
      { destMap:'overworld', destX:52, destY:25, triggerX:1,  triggerY:11 },
      { destMap:'cave',      destX:4,  destY:2,  triggerX:12, triggerY:20 },
    ],
  },
  cave: {
    ...
    connections: [
      { destMap:'town',      destX:12, destY:19, triggerX:4,  triggerY:1 },
      { destMap:'void_lands',destX:4,  destY:15, triggerX:18, triggerY:18 },
    ],
  },
  void_lands: {
    ...
    ambience: 'corrupted',
    connections: [
      { destMap:'cave',    destX:17, destY:17, triggerX:3,  triggerY:15 },
      { destMap:'citadel', destX:3,  destY:10, triggerX:32, triggerY:15 },
    ],
  },
  citadel: {
    ...
    ambience: 'dark',
    connections: [
      { destMap:'void_lands', destX:30, destY:15, triggerX:1, destY:10 },
    ],
  },
};
